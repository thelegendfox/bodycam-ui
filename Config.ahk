...
global Name := "J. Crown [3475] (Rockethead293)"
...
global TimeZone := "CST" ; https://en.wikipedia.org/wiki/List_of_time_zone_abbreviation
...
global TriggerSound := ".\resources\R5_alert_axon.wav"
...
global BodycamTrigger := "F1"
global ExitTrigger := "^F1" ; This is what closes the UI.
global ReloadTrigger := "F12" ; And this reloads it.
...
global ClippingKey := "F8"
global RecordingKey := "F7"
